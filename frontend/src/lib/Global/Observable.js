/**
 *
 * this is the ESx proposal as polyfill for observables
 *  *
 * https://raw.githubusercontent.com/tc39/proposal-observable/master/src/Observable.js
 *
 */
...
export class Observable {
    ...
    subscribe(observer, ...args) {
        if (typeof observer === "function") {
            observer = {
                next: observer, error: args[0], complete: args[1]
            };
